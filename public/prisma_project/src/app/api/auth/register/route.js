...
export async function POST(request) {
  ...
  try {
    ...
    const user = await prisma.user.create({ data: { name, email: email.toLowerCase(), password: hashed, role, studentId, departmentId, semester, section, shift, isVerified: true } });
